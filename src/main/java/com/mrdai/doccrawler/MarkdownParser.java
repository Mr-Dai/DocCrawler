...
public class MarkdownParser {
    ...
    public MarkdownParser() {
        ...
        appendElementAction(hasTagName("li"), (e) -> {
            MarkdownNode entry = new ChildNode();
        ...
        appendElementAction(hasTagName("img"), (e) -> {
            ...
            return new ImageNode(e.attr("alt"), src, "");
        });
        ...
        appendElementAction(hasTagName("hr"), (e) -> new HorizontalRule());
        appendElementAction(hasTagName("br"), (e) -> new LineBreak());
        appendElementAction(hasTagName("code"), (e) -> new InlineCode(e.text()));
        appendElementAction(hasTagName("a"), (e) -> {
    ...
    public void prependAction(Predicate<Node> predicate, Function<Node, MarkdownNode> action) {
        if (fixed)
            throw new IllegalStateException("The parser is already fixed and cannot add any other action.");
    ...
    public MarkdownNode parse(Node element) {
        if (!fixed)
            throw new IllegalStateException("The parser is not fixed yet.");
        for (PredicateAction action : actions)
